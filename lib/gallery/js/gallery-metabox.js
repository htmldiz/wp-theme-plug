  ...
  $(document).on('click', '#gallery-metabox a.gallery-add', function(e) {
    ...
    file_frame.on('select', function() {
      ...
      selection.map(function(attachment, i) {
        ...
        $('#gallery-metabox-list').append('<li><input type="hidden" name="gallery[' + index + ']" value="' + attachment.id + '"><img class="image-preview" src="' + attachment.sizes.thumbnail.url + '"><a class="change-image button button-small" href="#" data-uploader-title="Изменить" data-uploader-button-text="Изменить">Изменить</a><br><small><a class="remove-image" href="#">Удалить</a></small></li>');
      });
    });
